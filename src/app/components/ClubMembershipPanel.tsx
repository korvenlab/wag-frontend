...
/** Só configuração do plano do clube (+ membros). Saldo/PIX ficam em Pagamentos. */
      ...
      <Card className="rounded-[32px] border-none shadow-wg-elevated bg-white">
        <CardHeader>
          ...
          <p className="text-sm text-slate-500 font-medium leading-relaxed">
            Configure o plano mensal e compartilhe o link. O pagamento e o saque ficam em{" "}
            <strong className="text-slate-700">Pagamentos</strong> (taxa Wagoo {fee}%).
          </p>
        </CardHeader>
        <CardContent className="space-y-5">
          {!paymentsReady && (
            <p className="text-amber-800 text-sm font-medium bg-amber-50 rounded-xl px-4 py-3 leading-relaxed">
              Pagamentos ainda em configuração. Você já pode montar o plano; a cobrança libera
