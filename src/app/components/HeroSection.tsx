      ...
      <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="space-y-4 text-left">
            ...
            >
              Sua agenda <br /> 
              <span className="text-[#4d8f3b]">no automático.</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center">
            <Button className="h-14 min-h-[48px] sm:h-16 px-8 sm:px-10 rounded-2xl bg-slate-900 text-white font-bold hover:bg-[#64b34d] transition-all shadow-2xl group border border-slate-700 focus-visible:ring-2 focus-visible:ring-[#64b34d] focus-visible:ring-offset-2">
              Começar Agora
        ...
        >
          ...
          <div className="relative w-full h-full bg-white rounded-[40px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-slate-200 overflow-hidden flex flex-col">
            ...
            <div className="flex-1 grid grid-cols-2">
               ...
               <div className="p-8 border-r border-slate-200 space-y-4">
                  <div className="flex items-center gap-2 mb-6">
                     <div className="w-8 h-8 rounded-full bg-[#64b34d] flex items-center justify-center text-white shadow-lg shadow-green-100 border border-slate-200">
                  ...
                  <div className="space-y-4">
                     ...
                     <motion.div
                        ...
                        className="bg-[#64b34d] p-3.5 rounded-2xl rounded-tr-none text-xs text-white font-bold shadow-md shadow-green-100 border border-[#4d8f3b]"
                      >
               ...
               <div className="p-8 bg-slate-50/30 flex flex-col justify-center items-center text-center">
                  <motion.div
                    ...
                    className="w-full bg-white p-6 rounded-[32px] shadow-2xl shadow-blue-100/50 border border-slate-200"
                  >
                     <div className="w-12 h-12 rounded-2xl bg-[#4285F4] flex items-center justify-center text-white mx-auto mb-4 shadow-lg shadow-blue-200 border border-slate-200">
                        <Calendar size={22} />
                     </div>
          ...
          <motion.div
            ...
            className="absolute -right-2 -bottom-2 sm:-right-6 sm:-bottom-6 bg-slate-900 text-white p-4 sm:p-6 rounded-[24px] sm:rounded-[32px] shadow-2xl flex items-center gap-4 z-40 border border-slate-600"
          >
