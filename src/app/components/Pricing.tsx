    ...
    <section id="precos" ref={ref} className="relative py-24 md:py-32 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 text-slate-700 font-bold">
                <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-[#64b34d]">
          ...
          >
            {/* Badge de Oferta */}
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20 bg-slate-900 text-white px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest shadow-2xl">
              🔥 Oferta por Tempo Limitado
            </div>

            <div className="relative bg-white rounded-[48px] p-8 md:p-12 border border-slate-100 shadow-[0_30px_70px_-10px_rgba(0,0,0,0.1),0_50px_100px_-15px_rgba(0,0,0,0.05)]">
              <div className="mb-8">
              ...
              <div className="space-y-4 mb-10">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-4">
                    <div className="w-8 h-8 rounded-xl bg-green-50 flex items-center justify-center text-[#64b34d]">
                      {feature.icon}
                    </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-5 rounded-2xl bg-gradient-to-r from-[#64b34d] to-[#4d8f3b] text-white font-black text-lg shadow-xl shadow-green-100 transition-all flex items-center justify-center gap-3 disabled:opacity-70"
              >
