...
const meta = getSeoPageByPath("/agendamento/whatsapp")!;

export function AgendamentoWhatsappPage() {
  return (
    <ContentSeoPage
      meta={meta}
      h1="Agendamento no WhatsApp sem perder o fio da meada"
      lead="Se o seu cliente já marca horário pelo zap, o gargalo não é o canal — é você ter que responder cada mensagem. O Wagoo automatiza agendamentos no WhatsApp e grava no Google Calendar."
      sections={[
        {
          ...
          body: [
            ...
            "Agendamento no WhatsApp de verdade não é bot genérico: é confirmar disponibilidade real e registrar o horário onde você realmente trabalha — no Google Calendar.",
          ],
        },
        {
          heading: "O que o Wagoo faz na prática",
          body: [
            "O cliente escreve como sempre escreve. O Wagoo entende o pedido de agendamento, consulta sua agenda, confirma o horário e sincroniza o evento.",
        ...
        },
        {
          ...
          body: [
            ...
            "Se a sua operação ainda depende de copiar horário do chat para a agenda, automatizar agendamentos no WhatsApp é o atalho mais barato para recuperar tempo.",
          ],
        },
      ]}
      relatedLinks={[
